...
#Github：https://github.com/uxh/aliyun-oss-autobackup
...
#Aliyun API setting
apiaccesskeyid="x2L3EQpp63QLTdEUXpRkkRZmN8dkL3kpK8QG" #needed
apiaccesskeysecret="F9Ja7SbIYRYYdaCD9PyA8UZUvqcc1DG4" #needed

#Aliyun OSS setting
ossendpoint="oss-cn-shenzhen.aliyuncs.com" #needed
ossbucketname="example-1234567890" #needed
